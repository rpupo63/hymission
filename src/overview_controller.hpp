...
class OverviewController {
  ...
  private:
    ...
    [[nodiscard]] double       overviewWorkspaceSwipeMaxStepFraction() const;
    [[nodiscard]] double       overviewWorkspaceSwipeCommitDistance() const;
    void                       refreshManagedExitGeometryFromCompositor();
    [[nodiscard]] void*        resolveStripRenderWorkspaceFn() const;
    [[nodiscard]] void*        resolveStripRenderAllClientsForWorkspaceFn() const;
    [[nodiscard]] void*        resolveStripRenderWorkspaceWindowsFn() const;
    [[nodiscard]] void*        resolveStripRenderWindowFn() const;
    void                       applyOverviewWorkspaceVisibilitySuppression();
    void                       restoreOverviewWorkspaceVisibilitySuppression();
    void                       enforceOverviewWorkspaceVisibility() const;
    void                       applyOverviewWorkspaceRenderOffsetFreeze();
    void                       restoreOverviewWorkspaceRenderOffsetFreeze();
    [[nodiscard]] bool         isEmptyOwnerWorkspaceOverview(const State& state) const;
    [[nodiscard]] bool         ownerWorkspaceHasMappedWindows(const PHLWORKSPACE& workspace) const;
